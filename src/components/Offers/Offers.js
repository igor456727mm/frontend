...
import { Form, Table, Select, Input, DatePicker, Button, message, Popover, Tabs } from 'antd'
  ...
  render() {
    ...
    return (
      <Tabs type="card">
        ...
        <TabPane tab="Запросы доступа" key="2">
          <OfferRequests />
        </TabPane>
      </Tabs>
    )
